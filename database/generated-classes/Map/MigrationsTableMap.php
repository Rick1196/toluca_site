...
class MigrationsTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Migration', 'Batch', ),
        self::TYPE_CAMELNAME     => array('id', 'migration', 'batch', ),
        self::TYPE_COLNAME       => array(MigrationsTableMap::COL_ID, MigrationsTableMap::COL_MIGRATION, MigrationsTableMap::COL_BATCH, ),
        self::TYPE_FIELDNAME     => array('id', 'migration', 'batch', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Migration' => 1, 'Batch' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'migration' => 1, 'batch' => 2, ),
        self::TYPE_COLNAME       => array(MigrationsTableMap::COL_ID => 0, MigrationsTableMap::COL_MIGRATION => 1, MigrationsTableMap::COL_BATCH => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'migration' => 1, 'batch' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(MigrationsTableMap::COL_ID);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(MigrationsTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(MigrationsTableMap::COL_ID) && $criteria->keyContainsValue(MigrationsTableMap::COL_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.MigrationsTableMap::COL_ID.')');
        }
