...
class UsersTableMap extends TableMap
{
     ...
     */
    const COL_CVEENTROL = 'users.cveentrol';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Email', 'Cveentrol', 'Password', 'RememberToken', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'email', 'cveentrol', 'password', 'rememberToken', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_NAME, UsersTableMap::COL_EMAIL, UsersTableMap::COL_CVEENTROL, UsersTableMap::COL_PASSWORD, UsersTableMap::COL_REMEMBER_TOKEN, UsersTableMap::COL_CREATED_AT, UsersTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'email', 'cveentrol', 'password', 'remember_token', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Email' => 2, 'Cveentrol' => 3, 'Password' => 4, 'RememberToken' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'email' => 2, 'cveentrol' => 3, 'password' => 4, 'rememberToken' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_NAME => 1, UsersTableMap::COL_EMAIL => 2, UsersTableMap::COL_CVEENTROL => 3, UsersTableMap::COL_PASSWORD => 4, UsersTableMap::COL_REMEMBER_TOKEN => 5, UsersTableMap::COL_CREATED_AT => 6, UsersTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'email' => 2, 'cveentrol' => 3, 'password' => 4, 'remember_token' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('cveentrol', 'Cveentrol', 'INTEGER', 'catentrol', 'cveentrol', true, 10, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersTableMap::COL_CVEENTROL);
