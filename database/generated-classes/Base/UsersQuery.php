 ...
 * @method     ChildUsersQuery orderByCveentrol($order = Criteria::ASC) Order by the cveentrol column
 ...
 * @method     ChildUsersQuery groupByCveentrol() Group by the cveentrol column
 ...
 *
 * @method     ChildUsersQuery leftJoinCatentrol($relationAlias = null) Adds a LEFT JOIN clause to the query using the Catentrol relation
 * @method     ChildUsersQuery rightJoinCatentrol($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Catentrol relation
 * @method     ChildUsersQuery innerJoinCatentrol($relationAlias = null) Adds a INNER JOIN clause to the query using the Catentrol relation
 *
 * @method     ChildUsersQuery joinWithCatentrol($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Catentrol relation
 *
 * @method     ChildUsersQuery leftJoinWithCatentrol() Adds a LEFT JOIN clause and with to the query using the Catentrol relation
 * @method     ChildUsersQuery rightJoinWithCatentrol() Adds a RIGHT JOIN clause and with to the query using the Catentrol relation
 * @method     ChildUsersQuery innerJoinWithCatentrol() Adds a INNER JOIN clause and with to the query using the Catentrol relation
 *
 * @method     ChildUsersQuery leftJoinForums($relationAlias = null) Adds a LEFT JOIN clause to the query using the Forums relation
 * @method     ChildUsersQuery rightJoinForums($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Forums relation
 * @method     ChildUsersQuery innerJoinForums($relationAlias = null) Adds a INNER JOIN clause to the query using the Forums relation
 *
 * @method     ChildUsersQuery joinWithForums($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Forums relation
 *
 * @method     ChildUsersQuery leftJoinWithForums() Adds a LEFT JOIN clause and with to the query using the Forums relation
 * @method     ChildUsersQuery rightJoinWithForums() Adds a RIGHT JOIN clause and with to the query using the Forums relation
 * @method     ChildUsersQuery innerJoinWithForums() Adds a INNER JOIN clause and with to the query using the Forums relation
 *
 * @method     ChildUsersQuery leftJoinTbldenuncia($relationAlias = null) Adds a LEFT JOIN clause to the query using the Tbldenuncia relation
 * @method     ChildUsersQuery rightJoinTbldenuncia($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Tbldenuncia relation
 * @method     ChildUsersQuery innerJoinTbldenuncia($relationAlias = null) Adds a INNER JOIN clause to the query using the Tbldenuncia relation
 *
 * @method     ChildUsersQuery joinWithTbldenuncia($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Tbldenuncia relation
 *
 * @method     ChildUsersQuery leftJoinWithTbldenuncia() Adds a LEFT JOIN clause and with to the query using the Tbldenuncia relation
 * @method     ChildUsersQuery rightJoinWithTbldenuncia() Adds a RIGHT JOIN clause and with to the query using the Tbldenuncia relation
 * @method     ChildUsersQuery innerJoinWithTbldenuncia() Adds a INNER JOIN clause and with to the query using the Tbldenuncia relation
 *
 * @method     \CatentrolQuery|\ForumsQuery|\TbldenunciaQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildUsers findOneByCveentrol(int $cveentrol) Return the first ChildUsers filtered by the cveentrol column
 ...
 * @method     ChildUsers requireOneByCveentrol(int $cveentrol) Return the first ChildUsers filtered by the cveentrol column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUsers[]|ObjectCollection findByCveentrol(int $cveentrol) Return ChildUsers objects filtered by the cveentrol column
...
abstract class UsersQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'blogrodolfodb', $modelName = '\\Users', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, email, cveentrol, password, remember_token, created_at, updated_at FROM users WHERE id = :p0';
        try {
    ...
    public function filterByCveentrol($cveentrol = null, $comparison = null)
    {
        if (is_array($cveentrol)) {
            ...
            if (isset($cveentrol['min'])) {
                $this->addUsingAlias(UsersTableMap::COL_CVEENTROL, $cveentrol['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($cveentrol['max'])) {
                $this->addUsingAlias(UsersTableMap::COL_CVEENTROL, $cveentrol['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UsersTableMap::COL_CVEENTROL, $cveentrol, $comparison);
    }
    ...
    public function filterByCatentrol($catentrol, $comparison = null)
    {
        if ($catentrol instanceof \Catentrol) {
            return $this
                ->addUsingAlias(UsersTableMap::COL_CVEENTROL, $catentrol->getCveentrol(), $comparison);
            ...
            return $this
                ->addUsingAlias(UsersTableMap::COL_CVEENTROL, $catentrol->toKeyValue('PrimaryKey', 'Cveentrol'), $comparison);
        } else {
     ...
     * @return $this|ChildUsersQuery The current query, for fluid interface
     */
    public function joinCatentrol($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
     ...
     */
    public function useCatentrolQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
    ...
    public function filterByForums($forums, $comparison = null)
    {
        if ($forums instanceof \Forums) {
            return $this
                ->addUsingAlias(UsersTableMap::COL_ID, $forums->getIdUser(), $comparison);
    ...
    public function filterByTbldenuncia($tbldenuncia, $comparison = null)
    {
        if ($tbldenuncia instanceof \Tbldenuncia) {
            return $this
                ->addUsingAlias(UsersTableMap::COL_ID, $tbldenuncia->getIdUser(), $comparison);
