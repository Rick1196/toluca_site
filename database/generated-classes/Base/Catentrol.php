...
/**
 * Base class that represents a row from the 'catentrol' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Catentrol implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CatentrolTableMap';
    ...
    /**
     * The value for the nomentrol field.
     *
     * @var        string
     */
    protected $nomentrol;
    ...
    /**
     * The value for the desentrol field.
     *
     * @var        string
     */
    protected $desentrol;
    ...
    /**
     * Initializes internal state of Base\Catentrol object.
     */
    ...
    /**
     * Compares this with another <code>Catentrol</code> instance.  If
     * <code>obj</code> is an instance of <code>Catentrol</code>, delegates to
     * <code>equals(Catentrol)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Catentrol The current object, for fluid interface
     */
    ...
    /**
     * Get the [nomentrol] column value.
     *
     * @return string
     */
    public function getNomentrol()
    {
        return $this->nomentrol;
    }

    /**
     * Get the [desentrol] column value.
     *
     * @return string
     */
    public function getDesentrol()
    {
        return $this->desentrol;
    }
     ...
     * @return $this|\Catentrol The current object (for fluent API support)
     */
    public function setCveentrol($v)
    {
        ...
        if ($this->cveentrol !== $v) {
            $this->cveentrol = $v;
            $this->modifiedColumns[CatentrolTableMap::COL_CVEENTROL] = true;
        }
    ...
    /**
     * Set the value of [nomentrol] column.
     *
     * @param string $v new value
     * @return $this|\Catentrol The current object (for fluent API support)
     */
    public function setNomentrol($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->nomentrol !== $v) {
            $this->nomentrol = $v;
            $this->modifiedColumns[CatentrolTableMap::COL_NOMENTROL] = true;
        }
    ...
    /**
     * Set the value of [desentrol] column.
     *
     * @param string $v new value
     * @return $this|\Catentrol The current object (for fluent API support)
     */
    public function setDesentrol($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->desentrol !== $v) {
            $this->desentrol = $v;
            $this->modifiedColumns[CatentrolTableMap::COL_DESENTROL] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CatentrolTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CatentrolTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CatentrolTableMap::translateFieldName('Cveentrol', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cveentrol = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CatentrolTableMap::translateFieldName('Nomentrol', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nomentrol = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CatentrolTableMap::translateFieldName('Desentrol', TableMap::TYPE_PHPNAME, $indexType)];
            $this->desentrol = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CatentrolTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CatentrolTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = CatentrolTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Catentrol'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCatentrolQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Catentrol::setDeleted()
     * @see Catentrol::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCatentrolQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CatentrolTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CatentrolTableMap::COL_CVEENTROL)) {
            $modifiedColumns[':p' . $index++]  = 'cveentrol';
        }
        if ($this->isColumnModified(CatentrolTableMap::COL_NOMENTROL)) {
            $modifiedColumns[':p' . $index++]  = 'nomentrol';
        }
        if ($this->isColumnModified(CatentrolTableMap::COL_DESENTROL)) {
            $modifiedColumns[':p' . $index++]  = 'desentrol';
        }
        if ($this->isColumnModified(CatentrolTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(CatentrolTableMap::COL_UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_at';
        }

        $sql = sprintf(
            'INSERT INTO catentrol (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'cveentrol':
                        ...
                        break;
                    case 'nomentrol':
                        $stmt->bindValue($identifier, $this->nomentrol, PDO::PARAM_STR);
                        break;
                    case 'desentrol':
                        $stmt->bindValue($identifier, $this->desentrol, PDO::PARAM_STR);
                        break;
                    case 'created_at':
    ...
    {
        $pos = CatentrolTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getNomentrol();
                break;
            case 2:
                return $this->getDesentrol();
                break;
            case 3:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Catentrol'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Catentrol'][$this->hashCode()] = true;
        $keys = CatentrolTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCveentrol(),
            $keys[1] => $this->getNomentrol(),
            $keys[2] => $this->getDesentrol(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setNomentrol($value);
                break;
            case 2:
                $this->setDesentrol($value);
                break;
            case 3:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setCveentrol($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setNomentrol($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setDesentrol($arr[$keys[2]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CatentrolTableMap::COL_CVEENTROL)) {
            $criteria->add(CatentrolTableMap::COL_CVEENTROL, $this->cveentrol);
        }
        if ($this->isColumnModified(CatentrolTableMap::COL_NOMENTROL)) {
            $criteria->add(CatentrolTableMap::COL_NOMENTROL, $this->nomentrol);
        }
        if ($this->isColumnModified(CatentrolTableMap::COL_DESENTROL)) {
            $criteria->add(CatentrolTableMap::COL_DESENTROL, $this->desentrol);
        }
        if ($this->isColumnModified(CatentrolTableMap::COL_CREATED_AT)) {
            $criteria->add(CatentrolTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(CatentrolTableMap::COL_UPDATED_AT)) {
            $criteria->add(CatentrolTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildCatentrolQuery::create();
        $criteria->add(CatentrolTableMap::COL_CVEENTROL, $this->cveentrol);
    ...
    {
        $validPk = null !== $this->getCveentrol();
    ...
    /**
     * Generic method to set the primary key (cveentrol column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Catentrol (or compatible) type.
    ...
    {
        $copyObj->setNomentrol($this->getNomentrol());
        $copyObj->setDesentrol($this->getDesentrol());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setCveentrol(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Catentrol Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCatentrol is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildCatentrol The current object (for fluent API support)
     */
    public function setRelperrols(Collection $relperrols, ConnectionInterface $con = null)
    {
        ...
        foreach ($relperrolsToDelete as $relperrolRemoved) {
            $relperrolRemoved->setCatentrol(null);
        }
     ...
     * Otherwise if this Catentrol is new, it will return
     * an empty collection; or if this Catentrol has previously
     * been saved, it will retrieve related Relperrols from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Catentrol.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    public function setUserss(Collection $userss, ConnectionInterface $con = null)
    {
        ...
        foreach ($userssToDelete as $usersRemoved) {
            $usersRemoved->setCatentrol(null);
        }
    ...
    {
        return (string) $this->exportTo(CatentrolTableMap::DEFAULT_STRING_FORMAT);
    }
