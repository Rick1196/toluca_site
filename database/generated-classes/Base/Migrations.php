...
abstract class Migrations implements ActiveRecordInterface
{
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MigrationsTableMap::COL_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MigrationsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MigrationsTableMap::translateFieldName('Batch', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = MigrationsTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MigrationsTableMap::COL_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MigrationsTableMap::COL_ID)) {
            $criteria->add(MigrationsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(MigrationsTableMap::COL_MIGRATION)) {
    ...
    {
        $criteria = ChildMigrationsQuery::create();
        $criteria->add(MigrationsTableMap::COL_ID, $this->id);
